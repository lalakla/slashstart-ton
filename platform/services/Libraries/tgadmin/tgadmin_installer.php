...
class TgadminInstaller extends ServiceInstaller
{
	...
	public function getInfo()
	{
		$info = [
				'id' => 'tgadmin',
				'groups' => ['messenger'],
				'title' => __('services.title_telegram_admin', 'Telegram Admin'),
				'description' => ('Чат-бот для работы в каналах и группах.'),
